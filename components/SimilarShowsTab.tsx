...
const SimilarShowsTab: React.FC<any> = () => {
  ...
  return (
    <section>
      <div className="w-full h-80 px-8 my-5">
        {/* top tabs */}
        <div className="flex justify-between items-center w-full">
          <h3 className="font-bold text-2xl text-[#191919]">
            Similar shows and clips
          </h3>
...
export default SimilarShowsTab;
